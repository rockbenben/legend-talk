...
1-1 उपकरण के रूप में भी: 160+ विचारकों से परामर्श करें।
...
सभी गोलमेज मोड में पहला संदेश भेजने से पहले सुझाए गए विषय दिखाई देते हैं:

- **टेम्पलेट गोलमेज** — प्रत्येक टेम्पलेट के विषय के अनुसार 3 प्रश्न (सभी 18 भाषाओं में उपलब्ध)
- **मैन्युअल गोलमेज** — प्रत्येक चयनित चरित्र से 1 प्रश्न (अधिकतम 5)। चरित्र जोड़ने या हटाने पर विषय अपडेट होते हैं।
...
- **160+ विचारक** 15 क्षेत्रों में
- **कस्टम चरित्र**
- **खोज** · **पसंदीदा** · **सिंक** (AES)
- **सोच का स्तर** · **कस्टम मॉडल** · **कस्टम LLM**
- **मल्टी-API**: OpenAI, Anthropic, DeepSeek + 21 अन्य
...
सभी कस्टम मॉडल ID सपोर्ट करते हैं। डिफ़ॉल्ट: DeepSeek V4 Flash।
