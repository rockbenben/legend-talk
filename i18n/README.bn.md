...
সকল গোলটেবিল মোডে প্রথম বার্তা পাঠানোর আগে প্রস্তাবিত বিষয় দেখানো হয়:

- **টেমপ্লেট গোলটেবিল** — প্রতিটি টেমপ্লেটের থিম অনুযায়ী ৩টি প্রশ্ন (সকল ১৮টি ভাষায় উপলব্ধ)
- **ম্যানুয়াল গোলটেবিল** — প্রতিটি নির্বাচিত চরিত্র থেকে ১টি প্রশ্ন (সর্বাধিক ৫টি)। চরিত্র যোগ বা সরালে বিষয় আপডেট হয়।
