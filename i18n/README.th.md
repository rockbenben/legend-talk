...
ใช้เป็นเครื่องมือ 1 ต่อ 1 ได้ด้วย: ปรึกษานักคิดกว่า 160 คน
...
โหมดโต๊ะกลมทุกรูปแบบจะแสดงหัวข้อแนะนำก่อนส่งข้อความแรก:

- **โต๊ะกลมเทมเพลต** — 3 คำถามที่ออกแบบตามธีมของแต่ละเทมเพลต (รองรับทั้ง 18 ภาษา)
- **โต๊ะกลมเลือกเอง** — 1 คำถามจากแต่ละตัวละครที่เลือก (สูงสุด 5) หัวข้อจะอัปเดตเมื่อเพิ่มหรือลบตัวละคร
...
- **160+ นักคิด** ใน 15 สาขา
- **ตัวละครกำหนดเอง**
- **ค้นหา** · **รายการโปรด** · **ซิงค์** (AES)
- **ระดับการคิด** · **โมเดลกำหนดเอง** · **LLM กำหนดเอง**
- **หลาย API**: OpenAI, Anthropic, DeepSeek + 21 อื่นๆ
...
ทั้งหมดรองรับ ID โมเดลกำหนดเอง ค่าเริ่มต้น: DeepSeek V4 Flash
