...
Funziona anche come strumento 1 a 1: consulta più di 160 pensatori.
...
- **Multi-API**: OpenAI, Anthropic, DeepSeek + 21 altri
...
Tutti supportano ID personalizzati. Default: DeepSeek V4 Flash.
