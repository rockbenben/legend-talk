...
También funciona como herramienta 1 a 1: consulta con más de 160 pensadores.
...
- **Multi-API**: OpenAI, Anthropic, DeepSeek + 21 más
...
Todos soportan IDs de modelo personalizados. Predeterminado: DeepSeek V4 Flash.
